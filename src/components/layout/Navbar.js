  ...
  return (
    ...
    <AppBar position="static">
      <Toolbar>
        ...
        <Typography variant="h6" className={classes.title}>FreeFrom</Typography>
    ...
    <Drawer open={state.drawer} onClose={toggleDrawer(false)}>
      <div className={classes.list} role="presentation" onClick={toggleDrawer(false)} onKeyDown={toggleDrawer(false)}>
        <List>
          ...
          <ListItem button key='Resource Categories' {...{ to: "/resource-categories"}} component={Link}>
        ...
        <Divider />
        <List>
        <ListItem button key='Contact' {...{ to: "/contact"}} component={Link}>
